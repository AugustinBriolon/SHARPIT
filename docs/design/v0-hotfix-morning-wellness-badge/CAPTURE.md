# Design — Morning wellness modal badge hotfix
...
Local HTML fixture mirroring the modal scale step, rendered headless at iPhone width. Vercel preview is auth-gated.
