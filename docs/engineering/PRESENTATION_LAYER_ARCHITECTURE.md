...
> **Role:** Engineering reference (server ViewModels).  
> **Not product law** — athlete intent and journey live in [`docs/product/PRODUCT.md`](../product/PRODUCT.md).  
> **Not design law** — visual / IA live in [`docs/design/`](../design/).  
> Historical Product Insight framing: [`docs/archive/product-layer-2026/`](../archive/product-layer-2026/).
