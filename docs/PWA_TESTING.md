...
| ------------------------------------------------------------------------------------------------------------------- | ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| Manifest + icons + favicons + apple-splash HTTP 200 (`image/*`) + sign-in head tags                                 | `e2e/pwa-manifest.spec.ts`            | Hard asserts on local `yarn test:e2e`; soft-skips if a protected preview returns SSO/HTML                                         |
