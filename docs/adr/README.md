...
| [ADR-026](./ADR-026-public-demo-mode.md)                                       | Public read-only demo mode                                                         | Superseded by ADR-049 (mechanism) |
...
| [ADR-038](./ADR-038-declared-training-availability.md)                         | Declared training availability sits beside the observed days, never replacing them | Accepted                          |
