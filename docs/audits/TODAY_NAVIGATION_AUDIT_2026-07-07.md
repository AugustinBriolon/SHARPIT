...
> **Archive.** Document daté, conservé comme trace d’audit. La hiérarchie faisant autorité est
> [`docs/design/INFORMATION_ARCHITECTURE.md`](../design/INFORMATION_ARCHITECTURE.md) ([ADR-022](../adr/ADR-022-temporal-product-navigation.md)).
> La route `/seances` citée plus bas n’existe pas : le catalogue de séances est `/training`.
