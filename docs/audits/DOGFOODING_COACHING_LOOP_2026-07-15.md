...
> **Related:** [`docs/audits/SNAPSHOT_QUALITY_V1_AUDIT_2026-07.md`](./SNAPSHOT_QUALITY_V1_AUDIT_2026-07.md) · [`docs/ATHLETE_SNAPSHOT.md`](../ATHLETE_SNAPSHOT.md) · [`docs/PWA_TESTING.md`](../PWA_TESTING.md) (the authoritative human-executable checklist for every finding in §0.1's "cannot verify" list) · [ADR-005](../adr/ADR-005-plan-safety-gate-placement.md) · [ADR-006](../adr/ADR-006-decision-memory-aggregate.md) · [ADR-007](../adr/ADR-007-coaching-explainability-presentation.md) · [ADR-008](../adr/ADR-008-pwa-offline-snapshot-and-sw-lifecycle.md)
