...
> **Status:** Authoritative specification. Governs all current and future inference models.
> **Supersedes:** no prior document — this is the first formal execution specification.
> **Cross-references:**
>
> - `docs/models/RECOVERY_MODEL.md` — first implemented model
> - `docs/models/TRAINING_STRESS_MODEL.md` — Tier 0 (not yet implemented)
> - `docs/models/FATIGUE_MODEL.md` — Tier 1 (not yet implemented)
> - `knowledge/decisions/ADR-004-signal-persistence.md` — Signal persistence strategy
