...
import type { StrengthPrescription } from '@/lib/planned-session/strength-prescription';
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-muted-foreground text-[10px] leading-relaxed">
        Ces exercices partent sur la montre via Garmin. La durée sert aux isométries (reps à 0).
      </p>
    </div>
  );
}
