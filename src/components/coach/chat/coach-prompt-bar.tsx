...
import { getNextMenuActiveIndex } from '@/components/coach/chat/coach-prompt-bar-keyboard';
import {
  PromptBarChips,
  PromptBarControls,
  PromptBarInputShell,
  SourcesMenu,
  type SourceRow,
} from '@/components/coach/chat/coach-prompt-bar-parts';
import { buildCoachContextPresets } from '@/lib/coach/chat/coach-context-presets';
