  ...
  return (
    <textarea
      ...
      className={cn(
        ...
        // 16px on phone prevents iOS focus zoom; denser type from sm up.
        'bg-transparent px-1.5 text-base [overflow-wrap:anywhere] outline-none sm:text-[13px]',
        tall
          ? 'min-h-9 py-2 leading-5 sm:min-h-7 sm:py-[5px] sm:leading-[18px]'
          : 'h-9 min-h-9 leading-9 sm:h-7 sm:min-h-7 sm:leading-7',
      )}
