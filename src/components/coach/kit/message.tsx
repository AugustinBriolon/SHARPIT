...
export {
  ...
  MessageBubbleGroup,
} from '@/components/coach/kit/message-bubble';
export { MessageScroller } from '@/components/coach/kit/message-scroller';
export type { MessageScrollerProps } from '@/components/coach/kit/message-scroller';
