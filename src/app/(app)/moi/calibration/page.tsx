...
/**
 * The single calibration editor.
 *
 * Not gated behind `ExpertOnly`: repairing a stale threshold is maintenance, so
 * the Plan hub's confidence line must lead somewhere actionable whatever the
 * athlete's reading level. What stays expert is the display of the metrics a
 * threshold scales — NP, IF, zone distributions — not setting the ruler itself.
 */
