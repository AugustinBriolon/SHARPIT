...
const F02_PRE_RACE_TAPER: FatigueBenchmarkScenario = {
  ...
  features: day({
    ...
    recovery: rec({
      ...
      subjectiveWellnessComponents: { mood: 5, energyLevel: 5, perceivedSoreness: 1, stressLevel: null },
    }),
...
const F04_PSYCHOLOGICAL_DOMINANT: FatigueBenchmarkScenario = {
  ...
  features: day({
    ...
    recovery: rec({
      ...
      subjectiveWellnessComponents: { mood: 1, energyLevel: 1, perceivedSoreness: 2, stressLevel: null },
    }),
    sessions: [],
  }),
  context: ctx({
...
const F05_ACUTE_HIGH_INTENSITY: FatigueBenchmarkScenario = {
  ...
  features: day({
    ...
    recovery: rec({
      ...
      subjectiveWellnessComponents: { mood: 3, energyLevel: 3, perceivedSoreness: 5, stressLevel: null },
    }),
    sessions: [
      sess({
        sportType: 'RUN',
