...
/** Concise FR line for clinical-sounding recovery / wellness alerts. */
export const ILLNESS_SYMPTOM_ADVICE_FR = 'En cas de symptômes, consulte un avis médical.';

/** Chip / alert prefix for atypical recovery (illnessRisk) signals. */
export const ATYPICAL_RECOVERY_SIGNAL_PREFIX = 'Signal de récupération atypique';
