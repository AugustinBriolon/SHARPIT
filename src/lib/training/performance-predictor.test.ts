...
describe('predictionToRaceGoalDefaults', () => {
  it('préremplit un objectif course à partir d’une prédiction', () => {
    const prediction: RunPrediction = {
      ...
      paceSecPerKm: 253,
      pace: '4:13/km',
      referenceLabel: '10 km',
      confidence: 'high',
    };

    expect(predictionToRaceGoalDefaults(prediction)).toEqual({
      title: '10 km · 42:15',
      kind: 'RACE',
      raceFormat: '10 km',
