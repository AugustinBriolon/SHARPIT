...
import type { DataCompleteness, AthleteState } from '../../digital-twin/types';
...
export type ReasoningSignals = {
  readonly overallVerdict: import('../../digital-twin/types').OverallVerdict;
  readonly physiologicalConsistency: import('../../digital-twin/types').PhysiologicalConsistency;
...
export type ReasoningModelOutput = {
  ...
  readonly reasoningState: import('../../digital-twin/types').ReasoningState;
  /** Canonical decision — single source of truth for product surfaces. */
  readonly decisionState: import('../../decision').DecisionState;
};
