...
import type { I18nItem } from '../inference/shared/types';
...
export type DecisionEngineInput = {
  ...
  readonly recovery: import('../digital-twin/types').RecoveryState | null;
  readonly fatigue: import('../digital-twin/types').FatigueState | null;
  readonly adaptation: import('../digital-twin/types').AdaptationState | null;
  readonly physicalHealth: import('../inference/physical-health/types').PhysicalHealthState | null;
  readonly environment:
    import('../inference/environment/types').EnvironmentalDecisionSnapshot | null;
  readonly environmentalImpact?: import('../environment').EnvironmentalImpact | null;
