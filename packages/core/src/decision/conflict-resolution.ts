...
import { arbitrateModelConflict, detectConflicts } from '../inference/reasoning/scoring';
import type { ModelDirections } from '../inference/reasoning/types';
...
function resolveConflict(
  ...
  verdict: import('../digital-twin/types').OverallVerdict,
): DecisionDomain | null {
