...
import type { RecoveryState, FatigueState, AdaptationStatus } from '../digital-twin/types';
import type { AdaptationModelContext, AdaptationVerdict } from '../inference/adaptation/types';
