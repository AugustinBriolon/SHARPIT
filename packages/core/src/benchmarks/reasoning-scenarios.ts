...
import type { RecoveryState, FatigueState, AdaptationState } from '../digital-twin/types';
import type { OverallVerdict, PhysiologicalConsistency } from '../digital-twin/types';
import type { ReasoningModelInput } from '../inference/reasoning/types';
