...
import type { PhysicalHealthState } from '../inference/physical-health/types';
import type { EnvironmentalTwinState } from '../inference/environment/types';

export type { EnvironmentalTwinState } from '../inference/environment/types';
...
export type { PhysicalHealthState } from '../inference/physical-health/types';
