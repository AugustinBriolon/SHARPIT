...
import type { WithingsParsedMeasurement } from '@sharpit/server/lib/integrations/withings/withings';
import type { RawBodyCompositionObservation } from '@sharpit/core/observation/types';
