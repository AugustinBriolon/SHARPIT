...
import type { MfpDayResult } from '@sharpit/server/lib/integrations/myfitnesspal/myfitnesspal';
import type { RawNutritionObservation } from '@sharpit/core/observation/types';
