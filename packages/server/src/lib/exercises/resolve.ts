import catalogJson from '@sharpit/server/data/exercises-catalog.json';
import { EXERCISE_ALIASES } from '@sharpit/server/lib/exercises/aliases';
import {
  exerciseGifUrl,
  exerciseThumbUrl,
  EXERCISE_MEDIA_ATTRIBUTION,
} from '@sharpit/server/lib/exercises/media';
import { exerciseTokens, normalizeExerciseKey } from '@sharpit/server/lib/exercises/normalize';
import type {
