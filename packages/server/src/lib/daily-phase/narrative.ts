import type { TodayGoalContext } from '@sharpit/server/lib/daily-phase/goal-context';
...
} from '@sharpit/server/lib/daily-phase/evening-context';
import type { OverallVerdict } from '@sharpit/server/lib/today/dashboard/today-mapping';
import type { TodayEffortLevel } from '@sharpit/server/lib/today/navigation/today-narrative-context';
import type {
  DailyPhase,
  DailyPhaseResolution,
  DailyPhaseWhyFocus,
} from '@sharpit/server/lib/daily-phase/types';
import { isForwardAdvicePhase, isPostTrainingPhase } from '@sharpit/server/lib/daily-phase/resolve';
import { dayLoadLabel } from '@sharpit/server/lib/daily-phase/day-load';
