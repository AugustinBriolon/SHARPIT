...
import { STEP_MIN_SECONDS } from '@sharpit/server/lib/planned-session/endurance/endurance-prescription';
import {
  DEFAULT_POOL_LENGTH_M,
  effectiveEndurancePrescription,
} from '@sharpit/server/lib/planned-session/endurance/endurance-session';
import { garminPushStaleness } from '@sharpit/server/lib/planned-session/endurance/endurance-staleness';
