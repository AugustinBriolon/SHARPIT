...
import type { StepSegment } from '@sharpit/server/lib/planned-session/endurance/endurance-segmentation';
import { segmentEnduranceActivity } from '@sharpit/server/lib/planned-session/endurance/endurance-segmentation';
import {
  resolveEnduranceTarget,
  type AthleteThresholds,
  type ResolvedTarget,
} from '@sharpit/server/lib/planned-session/endurance/endurance-targets';
import type { StreamSample } from '@sharpit/server/lib/streams/streams';
