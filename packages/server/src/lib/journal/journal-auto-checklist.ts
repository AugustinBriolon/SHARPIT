...
import type { JournalThresholds } from '@sharpit/server/lib/journal/journal-prefs';
import {
  JOURNAL_AUTO_ITEM_LABELS,
  type JournalAutoItemId,
} from '@sharpit/server/lib/journal/journal-auto-ids';
import { formatOutcomeValue } from '@sharpit/server/lib/journal/journal-habit-finding-copy';
