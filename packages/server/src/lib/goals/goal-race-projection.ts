...
import type { GoalPositionLeg } from '@sharpit/server/lib/goals/goal-position-audit';
import {
...
} from '@sharpit/server/lib/goals/goal-triathlon-samples';
import {
  estimateFtp,
  predictRunRaces,
  type PredictionConfidence,
} from '@sharpit/server/lib/training/periodization/performance-predictor';
import {
