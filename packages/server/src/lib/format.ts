...
/** @deprecated Prefer `SPORT_IDENTITY_TEXT` from `@sharpit/server/lib/activity/sport-identity`. */
export { SPORT_IDENTITY_TEXT as activityTypeColors } from '@sharpit/server/lib/activity/sport-identity';
