import type { BriefingDayContext } from '@sharpit/server/lib/briefing/briefing-context';
import { isSet } from '@sharpit/shared/value';
import type { CoachContext } from '@sharpit/server/lib/coach/context/coach-context';
