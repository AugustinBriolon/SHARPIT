...
describe('createHikeTrip', () => {
  ...
  it('creates a trip and links hike activities', async () => {
    const { createHikeTrip } = await import('@sharpit/server/lib/queries/hike-trips');
  ...
  it('throws when duplicate activity ids collapse below two members', async () => {
    const { createHikeTrip, HikeTripValidationError } =
      await import('@sharpit/server/lib/queries/hike-trips');
...
describe('updateHikeTrip', () => {
  ...
  it('allows removing a member when add ids are already in the trip', async () => {
    const { updateHikeTrip } = await import('@sharpit/server/lib/queries/hike-trips');
  ...
  it('blocks removing the last member', async () => {
    const { updateHikeTrip, HikeTripValidationError } =
      await import('@sharpit/server/lib/queries/hike-trips');
...
describe('deleteHikeTrip', () => {
  ...
  it('unlinks members then deletes the trip', async () => {
    const { deleteHikeTrip } = await import('@sharpit/server/lib/queries/hike-trips');
