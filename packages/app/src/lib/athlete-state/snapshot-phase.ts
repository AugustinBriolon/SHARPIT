...
} from '@sharpit/app/athlete-state/snapshot';
import type { PhaseNarrative } from '@sharpit/app/lib/daily-phase/narrative';
import { isSet } from '@sharpit/shared/value';
import { buildPhaseNarrative } from '@sharpit/app/lib/daily-phase/narrative';
import {
  buildDailyPhaseDayContext,
  minutesBetween,
} from '@sharpit/app/lib/daily-phase/day-context';
import { resolveDailyPhase, isForwardAdvicePhase } from '@sharpit/app/lib/daily-phase/resolve';
...
import { buildTodayEffortSnapshot } from '@sharpit/app/lib/today/navigation/today-narrative-context';
import type { ClientGoal } from '@sharpit/app/lib/query/types';
import { resolveTodayGoalContext } from '@sharpit/app/lib/daily-phase/goal-context';
import { pickTomorrowSessionHint } from '@sharpit/app/lib/daily-phase/evening-context';
import { formatLimitingFactorMessage } from '@sharpit/app/lib/athlete-state/snapshot-truthfulness';
