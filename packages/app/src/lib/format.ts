...
/** @deprecated Prefer `SPORT_IDENTITY_TEXT` from `@sharpit/app/lib/activity/sport-identity`. */
export { SPORT_IDENTITY_TEXT as activityTypeColors } from '@sharpit/app/lib/activity/sport-identity';
