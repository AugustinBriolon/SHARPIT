...
import { formatEquipmentForCoach, equipmentSportHint } from '@sharpit/app/lib/equipment/format';
import {
  ...
  setStrengthVenue,
  toggleOwnedItem,
} from '@sharpit/app/lib/equipment/parse';
import { EMPTY_ATHLETE_EQUIPMENT, type AthleteEquipment } from '@sharpit/app/lib/equipment/types';
