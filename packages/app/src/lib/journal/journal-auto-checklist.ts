...
import type { JournalThresholds } from '@sharpit/app/lib/journal/journal-prefs';
import {
  JOURNAL_AUTO_ITEM_LABELS,
  type JournalAutoItemId,
} from '@sharpit/app/lib/journal/journal-auto-ids';
import { formatOutcomeValue } from '@sharpit/app/lib/journal/journal-habit-finding-copy';
