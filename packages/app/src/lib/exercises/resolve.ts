import catalogJson from '@sharpit/app/data/exercises-catalog.json';
import { EXERCISE_ALIASES } from '@sharpit/app/lib/exercises/aliases';
import {
  exerciseGifUrl,
  exerciseThumbUrl,
  EXERCISE_MEDIA_ATTRIBUTION,
} from '@sharpit/app/lib/exercises/media';
import { exerciseTokens, normalizeExerciseKey } from '@sharpit/app/lib/exercises/normalize';
import type { ExerciseCatalogEntry, ResolvedExerciseMedia } from '@sharpit/app/lib/exercises/types';
