...
import type { PlanGoalView } from '@sharpit/app/lib/plan/trajectory/plan-goal';
import {
  adaptedSessionsThisWeek,
  coachingAdvancementEntriesThisWeek,
  type CoachingAdvancementEntry,
} from '@sharpit/app/lib/plan/coaching-advancement-ledger';
import type { PlanWeekDayState } from '@sharpit/app/lib/plan/week/plan-week';
import { goalDeepLinkHref } from '@sharpit/app/lib/today/rich/today-goal-anchor';
import type { RearrangePreviewTone } from '@sharpit/app/lib/today/rich/rearrange-preview';
