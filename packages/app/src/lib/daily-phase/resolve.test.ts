...
import {
  ...
  isPostTrainingPhase,
} from '@sharpit/app/lib/daily-phase/resolve';
import type { DailyPhaseAthleteSignals, DailyPhaseInput } from '@sharpit/app/lib/daily-phase/types';
import { DAILY_PHASE_PRIMARY_QUESTION } from '@sharpit/app/lib/daily-phase/types';
