...
- Busso, T. (2003) — validation du modèle EWMA dans *Medicine & Science in Sports & Exercise*
...
const chronicWeeklyAvg = activities
  .filter((a) => inRange(a.date, chronicStart))
...
**Sources** :
- Gabbett, T.J. (2016) — "The training-injury prevention paradox" dans *British Journal of Sports Medicine*
...
**Sources** :
- Coggan, A. & Allen, H. (2006) — *Training and Racing with a Power Meter*
...
**Sources** :
- Riegel, P.S. (1981) — "Athletic records and human endurance" dans *American Scientist*
...
**Nuance importante** :
- FTP test standard (95% meilleur 20 min) suppose effort maximal *soutenu*
...
- Buchheit, M. (2014) — "Monitoring training status with HR measures" dans *Sports Medicine*
...
```typescript
const isDeload = (block.phase === 'BASE' || block.phase === 'BUILD') 
  && buildWeekCounter > 0 
...
**Sources** :
- Rhea et al. (2002) — "Periodized training for strength" dans *Journal of Strength & Conditioning Research*
- Plisk & Stone (2003) — "Periodization strategies" dans *Strength & Conditioning Journal*
...
**Sources** :
- Esteve-Lanao et al. (2005) — "Running performance and cardiac drift" dans *Medicine & Science in Sports & Exercise*
- Friel, J. (2009) — *The Cyclist's Training Bible* (popularisation EF)
...
- Coggan, A.R. (2003). "Training and Racing Using a Power Meter: An Introduction." *USA Cycling*.
...
- Plews, D.J., et al. (2013). "Training adaptation and heart rate variability in elite endurance athletes." *International Journal of Sports Physiology and Performance*, 8(2), 187-193.
...
*Document vivant, mis à jour lors de chaque modification d'algorithme ou découverte scientifique.*  
