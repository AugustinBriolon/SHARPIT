/**
 * FATIGUE INTELLIGENCE — Benchmark Suite (CI gate)
 *
 * This test runs the full Fatigue benchmark suite and asserts deployment-gate
...
import { runFatigueBenchmark } from '../fatigue-runner';
import { FATIGUE_BENCHMARK_SCENARIOS } from '../fatigue-scenarios';

describe('Fatigue Intelligence v1 — Scientific Benchmark', () => {
  const report = runFatigueBenchmark(FATIGUE_BENCHMARK_SCENARIOS, 'v1');
