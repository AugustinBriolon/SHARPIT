...
import { todayLoadingShell } from '@sharpit/server/lib/presentation/today/today-loading-shell';
 ...
 * the reader as each one arrives. Daily briefing stays off the shell: it returns
 * null while pending and must not invent chrome or copy during cold start.
 */
