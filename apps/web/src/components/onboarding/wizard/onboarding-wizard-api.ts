...
import { providersForClass } from '@sharpit/app/lib/integrations/provider-catalog';
...
import type { TrainingAvailability } from '@sharpit/app/lib/training-availability/types';
import {
