...
import { CoachViewLayout } from '@/components/coach/view/coach-view-layout';
import { useCoachDiscussBootstrap } from '@/components/coach/discuss/use-coach-discuss-bootstrap';
import {
  useCoachConversationSelection,
  useCoachDiscussParams,
} from '@/components/coach/discuss/use-coach-conversation-selection';
import { useCoachViewChat } from '@/components/coach/view/use-coach-view-chat';
import { useConfirmDialog } from '@/components/ui/confirm-dialog';
import { useDeleteConversation, useRenameConversation } from '@/hooks/use-coach';
import { useOfflineGuard } from '@/hooks/use-offline-guard';
import { useOnlineStatus } from '@/hooks/use-online-status';
import { useIsMobile } from '@/hooks/use-viewport';
import { clearCoachInputDraft } from '@sharpit/app/lib/coach/chat/composer/coach-input-draft';
