import { decryptSecret, isEncryptedSecret } from '@/lib/secret-box';
import { revokeGoogleToken } from '@/lib/integrations/google/google';
import { getGoogleAccount } from '@/lib/integrations/google/google-sync';
import { deauthorizeStrava } from '@/lib/integrations/strava/strava';
import { getStravaAccount, getValidAccessToken } from '@/lib/integrations/strava/strava-sync';
import { revokeWithingsAuthorization } from '@/lib/integrations/withings/withings';
